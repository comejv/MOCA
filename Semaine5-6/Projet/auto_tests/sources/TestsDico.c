...
void test_insertDico(CuTest *tc)
{
    ...
    *dico_actual = NULL;
    ...
    CuAssertPtrEquals(tc, (*dico_actual)->mot->data.tete_liste->next,
                      (*dico_actual)->mot->data.queue_liste);
...
void test_addToDico(CuTest *tc)
{
    ...
    *dico_actual = NULL;
    ...
    CuAssertPtrEquals(tc, (*dico_actual)->mot->data.tete_liste,
                      (*dico_actual)->mot->data.queue_liste);
    ...
    CuAssertPtrEquals(tc, (*dico_actual)->fg->mot->data.tete_liste,
                      (*dico_actual)->fg->mot->data.queue_liste);
    freeDico(*dico_actual);
    free(dico_actual);
}
